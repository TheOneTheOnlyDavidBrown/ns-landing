...
export default function Contact() {
  ...
  return (
    <>
      <Head>
        <title>Contact Us - NoteSleuth</title>
        <meta name="description" content="Get in touch with NoteSleuth to learn more about our platform and how we can help you with mortgage note investing." />
        <meta name="keywords" content="contact NoteSleuth, mortgage note investing support, NoteSleuth help" />
        <meta property="og:title" content="Contact Us - NoteSleuth" />
        <meta property="og:description" content="Get in touch with NoteSleuth to learn more about our platform and how we can help you with mortgage note investing." />
        <meta property="og:url" content="https://notesleuth.com/contact" />
      </Head>
